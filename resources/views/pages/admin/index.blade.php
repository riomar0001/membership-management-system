...
<div class="flex flex-row gap-4">
  <div class="w-full md:w-1/2 p-4 md:p-5 min-h-102.5 flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
    <!-- Header -->
