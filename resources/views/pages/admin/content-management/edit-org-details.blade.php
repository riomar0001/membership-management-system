    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <form action="{{ route('org-details.store') }}" method="POST">
            ...
            <div class="mt-8">
                ...
                <input type="text" name="logo" id="logo" value="{{ $logo }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-neutral-700 dark:border-neutral-600 dark:text-neutral-300" required>
            </div>
            ...
            <div class="mt-8">
                ...
                <input type="text" name="faqs" id="faqs" value="{{ $faqs }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm dark:bg-neutral-700 dark:border-neutral-600 dark:text-neutral-300" required>
            </div>
