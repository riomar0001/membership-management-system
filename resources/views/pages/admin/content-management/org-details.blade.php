                ...
                <div class="p-6">
                    <div class="grid gap-y-8">
                        <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 sm:p-6">
                            ...
                            <img src="{{ route('landing.logo', $logo) }}" alt="logo" loading="lazy"
                                class=" max-w-3xl mt-5 self-center">
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 sm:p-6">
                            ...
                            <div class="mt-4 space-y-4">
                                @if (is_array($faqs) || is_object($faqs))
                                    @foreach ($faqs as $faq)
                                        <div
                                            class="border-b border-gray-200 dark:border-neutral-700 pb-3 mb-3 last:border-0 last:pb-0 last:mb-0">
                ...
                <div class="p-6 flex flex-col items-center justify-center">
                    <div class="flex flex-col text-center justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24"
                            fill="none" stroke="#846c6c" stroke-width="0.75" stroke-linecap="round"
                        ...
                        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-neutral-200">No Organization
