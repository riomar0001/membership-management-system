            ...
            <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-800">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-neutral-400">
                        Organization social media profiles and information
                    </p>
                </div>
                    ...
                    <div class="grid gap-y-8">
                        <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 sm:p-6">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-blue-600">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                                </svg>
                                <h3 class="text-base font-semibold text-gray-800 dark:text-neutral-200 ml-3">
                                    Facebook
                                </h3>
                            </div>
                        ...
                        <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 sm:p-6">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-sky-500">
                        ...
                        <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 sm:p-6">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-pink-600">
            ...
            @else
                <div class="p-6 flex flex-col items-center justify-center">
                    <div class="flex flex-col text-center justify-center items-center">
                            ...
                            Please add social media details for the organization.
                        </p>
                        <div class="mt-6">
                            <a href="{{ route('socials.show') }}" 
