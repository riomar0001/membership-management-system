    ...
    <div class="px-4 py-5 sm:px-6 lg:px-5 lg:py-5 mx-auto bg-white dark:bg-neutral-900 rounded-xl shadow-xs">
        ...
        <div class="border-b border-gray-200 dark:border-neutral-700 pb-5 sm:pb-6 mb-5 sm:mb-6">
            ...
            <p class="text-sm text-gray-800 dark:text-neutral-200">
                Provide the organization social media links below.
            </p>
        </div>
                        ...
                        <div class="flex flex-col gap-y-2">
                            <label for="facebook" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-300">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-blue-600 mr-2">
                                        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                                    </svg>
                                    Facebook
                                </div>
                            </label>
                            <input id="facebook" type="text" name="facebook" value="{{ old('facebook') }}" placeholder="https://facebook.com/your-page"
                    ...
                    <div class="sm:col-span-8">
                        <div class="flex flex-col gap-y-2">
                            <label for="twitter" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-300">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-sky-500 mr-2">
                                        <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                                    </svg>
                                    Twitter
                                </div>
                            </label>
                            <input id="twitter" type="text" name="twitter" value="{{ old('twitter') }}" placeholder="https://twitter.com/your-page"
                                class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            @error('twitter')
                                <div class="text-red-500 text-xs">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="sm:col-span-8">
                        <div class="flex flex-col gap-y-2">
                            <label for="instagram" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-300">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-pink-600 mr-2">
                            ...
                            <input id="instagram" type="text" name="instagram" value="{{ old('instagram') }}" placeholder="https://instagram.com/your-page"
                                class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            @error('instagram')
                                <div class="text-red-500 text-xs">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="sm:col-span-8">
                        <div class="flex flex-col gap-y-2">
                            <label for="linkedin" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-300">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-blue-800 mr-2">
                            ...
                            <input id="linkedin" type="text" name="linkedin" value="{{ old('linkedin') }}" placeholder="https://linkedin.com/company/your-page"
                                class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            @error('linkedin')
                                <div class="text-red-500 text-xs">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="flex flex-col gap-y-2">
                            <label for="discord" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-300">
                                <div class="flex items-center gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 50 50" fill="blue">
                            ...
                            <input id="discord" type="text" name="discord" value="{{ old('discord') }}" placeholder="https://discord.gg/your-invitation"
                                class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                            @error('discord')
                                <div class="text-red-500 text-xs">{{ $message }}</div>
                            @enderror
