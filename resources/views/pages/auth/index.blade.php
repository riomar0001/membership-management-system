<x-layouts.auth>
    <section class="relative">
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-[90vh] lg:py-0">
            <div
                class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-neutral-900 dark:border-neutral-800">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <input type="email" name="umindanao_email" placeholder="University Email" id="email"
                                class="bg-neutral-50 border border-neutral-300 text-neutral-900 rounded-lg focus:ring-yellow-600 focus:border-yellow-600 block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="remember" aria-describedby="remember" type="checkbox" name="remember"
                                        class="w-4 h-4 border border-neutral-300 rounded bg-neutral-50 focus:ring-3 focus:ring-yellow-300 dark:bg-neutral-700 dark:border-neutral-600 dark:focus:ring-yellow-600 dark:ring-offset-neutral-800">
                                </div>
                        ...
                        <button type="submit"
                            class="w-full text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Sign
                            in</button>
                    </form>
                </div>
            </div>
